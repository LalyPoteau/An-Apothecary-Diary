...
import CardsIndividual from "../card_individual/card"
function Cards() {
    ...
    return (
        ...
        <div className="w-full min-h-screen gap-10 flex justify-center items-center p-4 md:p-8">
             {cards.map(card => (<CardsIndividual {...card} />
             ))}
        </div>
    )
}
